...
export default function AboutDhruvam() {
  return (
    <Section id="about">
      <div className="flex flex-col items-center gap-8 sm:flex-row sm:items-start sm:gap-10 sm:text-left">
        <Image
          src="/assets/dhruvam/characters/penguin-telescope.jpg"
          alt="Dhruva, the club mascot, searching the night sky through a telescope"
          width={896}
          height={1200}
          className="w-40 shrink-0 rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.4)] sm:w-48"
        />
        <div>
          ...
          <div className="mx-auto mt-6 max-w-2xl space-y-5 font-body text-lg leading-relaxed text-parchment/80 sm:mx-0">
            <p>
